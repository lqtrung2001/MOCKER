...
@Validated
@Api(value = "sql-type", description = "the sql-type API")
public interface SqlTypeApi {
     ...
     */
    @ApiOperation(value = "", nickname = "getSQLTypes", notes = "Get SQLTypes", response = SQLTypeDto.class, responseContainer = "List", tags={ "SQLType", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "The query is successful", response = SQLTypeDto.class, responseContainer = "List"),
