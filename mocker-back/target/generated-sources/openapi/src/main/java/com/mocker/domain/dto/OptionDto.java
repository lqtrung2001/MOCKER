...
public class OptionDto   {
   ...
   * @return id
  */
  @ApiModelProperty(readOnly = true, value = "Option id")
  ...
  public OptionDto blank(Integer blank) {
    this.blank = blank;
    return this;
  }
   ...
   * @return blank
  */
  @ApiModelProperty(value = "Blank of option")
...
@Min(0) @Max(100) 
  ...
  */
  ...
  public OptionDto createdDate(OffsetDateTime createdDate) {
  ...
  */
  ...
  public OptionDto createdBy(UUID createdBy) {
  ...
  */
  ...
  public OptionDto createdByGroup(UUID createdByGroup) {
  ...
  */
  ...
  public OptionDto modifiedDate(OffsetDateTime modifiedDate) {
  ...
  */
  ...
  public OptionDto modifiedBy(UUID modifiedBy) {
  ...
  */
  ...
  public OptionDto modifiedByGroup(UUID modifiedByGroup) {
  ...
  */
  ...
  public OptionDto version(Integer version) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, option.id) &&
        ...
        Objects.equals(this.createdByGroup, option.createdByGroup) &&
        Objects.equals(this.modifiedDate, option.modifiedDate) &&
        Objects.equals(this.modifiedBy, option.modifiedBy) &&
        Objects.equals(this.modifiedByGroup, option.modifiedByGroup) &&
