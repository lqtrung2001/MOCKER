...
@Component
public class ApiUserMapperImpl implements ApiUserMapper {
    ...
    public UserDto map(User user) {
        ...
        userDto.setIsAccountNonExpired( user.getIsAccountNonExpired() );
        userDto.setIsAccountNonLocked( user.getIsAccountNonLocked() );
        userDto.setIsCredentialsNonExpired( user.getIsCredentialsNonExpired() );
        userDto.setIsEnabled( user.getIsEnabled() );
        userDto.setGrantedAuthorities( user.getGrantedAuthorities() );
        userDto.setCreatedDate( user.getCreatedDate() );
        if ( user.getCreatedBy() != null ) {
            userDto.setCreatedBy( UUID.fromString( user.getCreatedBy() ) );
        }
        if ( user.getCreatedByGroup() != null ) {
            userDto.setCreatedByGroup( UUID.fromString( user.getCreatedByGroup() ) );
        }
        userDto.setModifiedDate( user.getModifiedDate() );
        if ( user.getModifiedBy() != null ) {
            userDto.setModifiedBy( UUID.fromString( user.getModifiedBy() ) );
        }
        if ( user.getModifiedByGroup() != null ) {
            userDto.setModifiedByGroup( UUID.fromString( user.getModifiedByGroup() ) );
        }
    ...
    protected GroupMember groupMemberDtoToGroupMember(GroupMemberDto groupMemberDto) {
        ...
        groupMember.user( map( groupMemberDto.getUser() ) );
    ...
    protected GenderDto genderToGenderDto(Gender gender) {
        ...
        switch ( gender ) {
            case MALE: genderDto = GenderDto.MALE;
            break;
            case FEMALE: genderDto = GenderDto.FEMALE;
            break;
            case OTHER: genderDto = GenderDto.OTHER;
            break;
