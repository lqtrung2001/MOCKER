...
@Component
public class ApiTableRelationMapperImpl implements ApiTableRelationMapper {

    @Autowired
    private ApiFieldMapper apiFieldMapper;

    @Override
    public TableRelation map(TableRelationDto tableRelationDto) {
        if ( tableRelationDto == null ) {
            return null;
        }

        TableRelation.TableRelationBuilder<?, ?> tableRelation = TableRelation.builder();

        tableRelation.createdDate( tableRelationDto.getCreatedDate() );
        if ( tableRelationDto.getCreatedBy() != null ) {
            tableRelation.createdBy( tableRelationDto.getCreatedBy().toString() );
        }
        if ( tableRelationDto.getCreatedByGroup() != null ) {
            tableRelation.createdByGroup( tableRelationDto.getCreatedByGroup().toString() );
        }
        tableRelation.modifiedDate( tableRelationDto.getModifiedDate() );
        if ( tableRelationDto.getModifiedBy() != null ) {
            tableRelation.modifiedBy( tableRelationDto.getModifiedBy().toString() );
        }
        if ( tableRelationDto.getModifiedByGroup() != null ) {
            tableRelation.modifiedByGroup( tableRelationDto.getModifiedByGroup().toString() );
        }
        tableRelation.version( tableRelationDto.getVersion() );
        tableRelation.id( tableRelationDto.getId() );
        tableRelation.description( tableRelationDto.getDescription() );
        tableRelation.relationType( relationTypeDtoToRelationType( tableRelationDto.getRelationType() ) );
        tableRelation.source( fieldDtoToField( tableRelationDto.getSource() ) );
        tableRelation.target( fieldDtoToField( tableRelationDto.getTarget() ) );

        return tableRelation.build();
    }

    @Override
    public TableRelationDto map(TableRelation tableRelation) {
        ...
        tableRelationDto.setId( tableRelation.getId() );
        tableRelationDto.setSource( apiFieldMapper.map( tableRelation.getSource() ) );
        tableRelationDto.setTarget( apiFieldMapper.map( tableRelation.getTarget() ) );
        tableRelationDto.setDescription( tableRelation.getDescription() );
        tableRelationDto.setRelationType( relationTypeToRelationTypeDto( tableRelation.getRelationType() ) );
        tableRelationDto.setCreatedDate( tableRelation.getCreatedDate() );
        if ( tableRelation.getCreatedBy() != null ) {
            tableRelationDto.setCreatedBy( UUID.fromString( tableRelation.getCreatedBy() ) );
        }
        if ( tableRelation.getCreatedByGroup() != null ) {
            tableRelationDto.setCreatedByGroup( UUID.fromString( tableRelation.getCreatedByGroup() ) );
        }
        tableRelationDto.setModifiedDate( tableRelation.getModifiedDate() );
        if ( tableRelation.getModifiedBy() != null ) {
            tableRelationDto.setModifiedBy( UUID.fromString( tableRelation.getModifiedBy() ) );
        }
        if ( tableRelation.getModifiedByGroup() != null ) {
            tableRelationDto.setModifiedByGroup( UUID.fromString( tableRelation.getModifiedByGroup() ) );
        }
        tableRelationDto.setVersion( tableRelation.getVersion() );

        return tableRelationDto;
    }

    @Override
    public List<TableRelationDto> map(List<TableRelation> tableRelations) {
        if ( tableRelations == null ) {
            return null;
        }

        List<TableRelationDto> list = new ArrayList<TableRelationDto>( tableRelations.size() );
        for ( TableRelation tableRelation : tableRelations ) {
            list.add( map( tableRelation ) );
        }

        return list;
    }

    protected RelationType relationTypeDtoToRelationType(RelationTypeDto relationTypeDto) {
        ...
        switch ( relationTypeDto ) {
            case ONE_TO_ONE: relationType = RelationType.ONE_TO_ONE;
            break;
            case ONE_TO_MANY: relationType = RelationType.ONE_TO_MANY;
            break;
            case MANY_TO_ONE: relationType = RelationType.MANY_TO_ONE;
            break;
            case MANY_TO_MANY: relationType = RelationType.MANY_TO_MANY;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + relationTypeDto );
        }
    ...
    protected GroupMember groupMemberDtoToGroupMember(GroupMemberDto groupMemberDto) {
        ...
        groupMember.group( groupDtoToGroup( groupMemberDto.getGroup() ) );
    ...
    protected RelationTypeDto relationTypeToRelationTypeDto(RelationType relationType) {
        ...
        switch ( relationType ) {
            case ONE_TO_ONE: relationTypeDto = RelationTypeDto.ONE_TO_ONE;
            break;
            case ONE_TO_MANY: relationTypeDto = RelationTypeDto.ONE_TO_MANY;
            break;
            case MANY_TO_ONE: relationTypeDto = RelationTypeDto.MANY_TO_ONE;
            break;
            case MANY_TO_MANY: relationTypeDto = RelationTypeDto.MANY_TO_MANY;
            break;
            default: throw new IllegalArgumentException( "Unexpected enum constant: " + relationType );
        }
